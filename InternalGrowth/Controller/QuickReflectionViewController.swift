...
class QuickReflectionViewController: UIViewController, UINavigationControllerDelegate, AVAudioRecorderDelegate {
    ...
    @IBAction func onGrowButtonPressed(_ sender: Any) {
        ...
        if let targetExperience = targetExperience, let keyword = keywordTextField.text {
            if let prompt = promptLabel.text {
                item.prompt = prompt
            }
...
extension QuickReflectionViewController: UIImagePickerControllerDelegate {
...
extension QuickReflectionViewController {
